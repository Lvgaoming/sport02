...
class Ui_Form(object):
    ...
    #场裁块
        ...
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.label.setText("青得分区间")
        self.label.setStyleSheet("border:0px")
        self.qingfanghujudefenqujian = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.qingfanghujudefenqujian.setGeometry(QtCore.QRect(120, 220, 40, 20))
        self.qingfanghujudefenqujian.setObjectName("hongfanghujufirst_lizhi")
        self.qingfanghujudefenqujian.setText("0")
        self.qingfanghujudefenqujian.setAlignment(QtCore.Qt.AlignCenter)
        self.qingfanghujudefenqujian.setFixedWidth(40)
        self.qingfanghujudefenqujian.setStyleSheet(
            "color:#000 ; border-radius:5px ; background-color:#FFE05E ;border-color:#FFE05E")

        # 红得分区间
        self.label = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label.setGeometry(QtCore.QRect(40, 200, 80, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.label.setFont(font)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.label.setText("红得分区间")
        self.label.setStyleSheet("border:0px")
        self.hongfanghujudefenqujian = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.hongfanghujudefenqujian.setGeometry(QtCore.QRect(120, 200, 40, 20))
        self.hongfanghujudefenqujian.setObjectName("hongfanghujudefenqujian")
        self.hongfanghujudefenqujian.setText("0")
        self.hongfanghujudefenqujian.setAlignment(QtCore.Qt.AlignCenter)
        self.hongfanghujudefenqujian.setFixedWidth(40)
        self.hongfanghujudefenqujian.setStyleSheet(
            "color:#000 ; border-radius:5px ; background-color:#FFE05E ;border-color:#FFE05E")
    ...
    def lianjie(self):
        if (self.isfirst):
            ...
            if (gl.get_value('bisaijushu') == None):
                ...
                sql = "select bisaixuhao from lizhi where bisaixuhao='%s'" % (gl.get_value('bisaixuhao'))
                if (self.stat.fetchone(sql)):
                    sql = "DELETE FROM lizhi WHERE bisaixuhao ='%s'" % (gl.get_value('bisaixuhao'))
                    # print(sql)
                    _thread.start_new_thread(self.stat.delete, (sql,))
                    time.sleep(1)
                    # self.stat.delete(sql)
                sql = "insert into lizhi (bisaixuhao,jibie) values (%s,'%s')" % (
                    gl.get_value('bisaixuhao'), gl.get_value('jibie'),
                ...
                self.qingfanghujudefenqujian.setText(str(self.defenqujian))
                self.hongfanghujudefenqujian.setText(str(self.defenqujian))
    ...
    def on_timeout(self):
        ...
        if (int(self.daojishinow) > 0):
            ...
            #         # self.hongsheng_bt.click()
            #         qw = QtWidgets.QWidget()
            #         QMessageBox.warning(qw, '红方胜', "红方加时胜", QMessageBox.Ok)
            #         self.flag = True
            #         self.isfight = False
            #         self.dataFlag2 = False
            #
            ...
            #         # self.qingsheng_bt.click()
            #         qw = QtWidgets.QWidget()
            #         QMessageBox.warning(qw, '青方胜', "青方加时胜", QMessageBox.Ok)
            #         self.flag = True
            #         self.isfight = False
            #         self.dataFlag2 = False
                    ...
                    if (self.dataFlag2):
                        ...
                        if(group_1=="7" or group_1=="8"):
                            if (group_1 == "7" and shebeinum==int(self.qingtoukuinum.text())):
                                ...
                                if ((self.qingfangtoukuitime - self.qingfangtoukuidefentime) > 0.8 and is_jida == "1"):
                            ...
                            if (group_1 == "8" and shebeinum==int(self.hongtoukuinum.text())):
                                ...
                                if ((self.hongfangtoukuitime - self.hongfangtoukuidefentime) > 0.8 and is_jida == "1"):
                                    ...
                                    self.fencha(int(self.qingfangdefen), int(self.hongfangzongfen.text()))
                        ...
                        if (group_1 == "2" or group_1 == "3"):
                            ...
                            if (group_1 == "2" and shebeinum==int(self.qinghujunum.text())):
                                ...
                                if (self.hongfanglizhi2 == ""):
                                    self.hongfanglizhi2 = str(lizhi)
                                else:
                                    self.hongfanglizhi2 = self.hongfanglizhi2 + "," + str(lizhi)
                                sql = "update lizhi set hongfanglizhi='%s' where bisaixuhao='%s'" % (
                                    self.hongfanglizhi2,
                                    gl.get_value('bisaixuhao'))
                                print(sql)
                                _thread.start_new_thread(self.stat.update, (sql,))
                            ...
                            if (group_1 == "3" and shebeinum==int(self.honghujunum.text())):
                                ...
                                lizhi = (self.transform_hex_data(myout[4]) << 8) + self.transform_hex_data(myout[3])
                                # print("力值--", lizhi)
                                if (self.qingfanglizhi2 == ""):
                                    self.qingfanglizhi2 = str(lizhi)
                                else:
                                    self.qingfanglizhi2 = self.qingfanglizhi2 + "," + str(lizhi)
                                sql = "update lizhi set qingfanglizhi='%s' where bisaixuhao='%s'" % (
                                    self.qingfanglizhi2,
                                    gl.get_value('bisaixuhao'))
                                # print(sql)
                                _thread.start_new_thread(self.stat.update, (sql,))
                        ...
                        if (group_1 == self.changcai_1_num.text() or group_1 == self.changcai_2_num.text() or group_1 == self.changcai_3_num.text()):
                            ...
                            if(group == "2"):
                                ...
                                if(group_1 == self.changcai_1_num.text()):
                                    ...
                                    sql = "update dangqianbisai set caipanqing1=%s where bisaixuhao=%s" % (
                                        dafenqi1_qing,
                                        gl.get_value('bisaixuhao'))
                                    print(sql)
                                    _thread.start_new_thread(self.stat.update, (sql,))
                                ...
                                if (group_1 == self.changcai_2_num.text()):
                                    ...
                                    sql = "update dangqianbisai set caipanqing2=%s where bisaixuhao=%s" % (
                                        dafenqi2_qing,
                                        gl.get_value('bisaixuhao'))
                                    print(sql)
                                    _thread.start_new_thread(self.stat.update, (sql,))
                                ...
                                if (group_1 == self.changcai_3_num.text()):
                                    ...
                                    sql = "update dangqianbisai set caipanqing3=%s where bisaixuhao=%s" % (
                                        dafenqi3_qing,
                                        gl.get_value('bisaixuhao'))
                                    print(sql)
                                    _thread.start_new_thread(self.stat.update, (sql,))
                            ...
                            if (group == "3"):
                                ...
                                if (group_1 == self.changcai_1_num.text()):
                                    ...
                                    sql = "update dangqianbisai set caipanhong1=%s where bisaixuhao=%s" % (
                                        dafenqi1_hong,
                                        gl.get_value('bisaixuhao'))
                                    # print(sql)
                                    _thread.start_new_thread(self.stat.update, (sql,))
                                ...
                                if (group_1 == self.changcai_2_num.text()):
                                    ...
                                    sql = "update dangqianbisai set caipanhong2=%s where bisaixuhao=%s" % (
                                        dafenqi2_hong,
                                        gl.get_value('bisaixuhao'))
                                    # print(sql)
                                    _thread.start_new_thread(self.stat.update, (sql,))
                                ...
                                if (group_1 == self.changcai_3_num.text()):
                                    ...
                                    sql = "update dangqianbisai set caipanhong3=%s where bisaixuhao=%s" % (
                                        dafenqi3_hong,
                                        gl.get_value('bisaixuhao'))
                                    # print(sql)
                                    _thread.start_new_thread(self.stat.update, (sql,))
