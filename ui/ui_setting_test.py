...
class Ui_Form(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.dangqianshijian.setText("60")
        ...
        self.chuankou.setStyleSheet(
         ...
         # 扣分数
        self.label = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label.setGeometry(QtCore.QRect(10, 330, 80, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.label.setFont(font)
        ...
        self.koufenshu.setGeometry(QtCore.QRect(88, 330, 40, 20))
